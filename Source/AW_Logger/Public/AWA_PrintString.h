...
public:
	...
	static void PrintString_Debug(const UObject* WorldContextObject, const FString& Message = FString("Hello"), const FString& Prefix = FString(""));
	...
	static void PrintString_Error(const UObject* WorldContextObject, const FString& Message = FString("Hello"), const FString& Prefix = FString(""));
	...
	static void PrintString_Info(const UObject* WorldContextObject, const FString& Message = FString("Hello"), const FString& Prefix = FString(""));
	...
	static void PrintString_Warning(const UObject* WorldContextObject, const FString& Message = FString("Hello"), const FString& Prefix = FString(""));
